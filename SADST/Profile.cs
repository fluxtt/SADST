...
namespace SADST
{
    ...
    internal class Profile
    {
        ...
        {
            var profileFolder = Path.Combine(Environment.CurrentDirectory, "SADST", ProfileName);
            var configFile = Path.Combine(profileFolder, "SADST_config.cfg");
            var basicConfigFile = Path.Combine(profileFolder, "SADST_basic.cfg");
            var parameters = "";

...
namespace SADST
{
    public partial class MainForm : Form
    {
        ...
        private void ValidateCurrentDirectory()
        {
            ...
            {
                MessageBox.Show("Are you sure you've put SADST in your ArmA game folder? " + Environment.NewLine +
                                "No 'MPMissions' folder is present in the current folder", "Cannot run SADST",
        ...
        {
            var path = Path.Combine(Environment.CurrentDirectory, @"SADST\SADST.profiles");
        ...
        private void SaveProfilesToDisk()
        {
            ...
            var filename = Path.Combine(Environment.CurrentDirectory, @"SADST\SADST.profiles");
        ...
        private static ProfileHandler LoadProfilesFromDisk()
        {
            ...
            using (FileStream fileStream = File.OpenRead(filename))
            {
                ...
                {
                    MessageBox.Show(
                        "Sorry, your 'SADST.profiles' file is either corrupted or incompatible with the current version of SADST. "
        ...
        private void btnMonitorRpt_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No RPT file present", "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            var file = Path.Combine(Environment.CurrentDirectory, "SADST", _activeProfile.ProfileName, rptFile);
        ...
        private void OpenMonitor(string monitorFile, string fileTitle)
        {
            ...
            {
                MessageBox.Show("No " + fileTitle + "file present", "SADST", MessageBoxButtons.OK,
        ...
        private void btnOpenRpt_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You need to select a proper server executable first.", "SADST", MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
            }
        }
        ...
        private void btnOpenNetLog_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No netlog file present", "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnOpenLogFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No console log file present", "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnOpenRankingFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No ranking file present", "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnOpenPidFile_Click(object sender, EventArgs e)
        {
            if (!_fileHandler.OpenPidFile())
            {
                MessageBox.Show(
                    ...
                    "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void btnLaunchwHeadless_Click(object sender, EventArgs e) {
            if (!_activeProfile.HeadlessEnabled) {
                MessageBox.Show("You must have Headless Clients Enabled.", "Headless Clients Disabled",
                    MessageBoxButtons.OK,
                ...
                System.Diagnostics.Process.Start(Environment.CurrentDirectory + "\\HC1.bat");
                System.Diagnostics.Process.Start(Environment.CurrentDirectory + "\\HC2.bat");
            }
        }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Process.Start(Path.Combine(Environment.CurrentDirectory, "SADST", _activeProfile.ProfileName));
            }
            catch (Exception exception)
            {
                MessageBox.Show(exception.Message);
        ...
        private void btnDeleteRpt_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(Path.Combine(Environment.CurrentDirectory, "SADST", _activeProfile.ProfileName, file)))
            {
        ...
        private void chkStartAsIs_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                var info =
                    new AsIsInfoForm(Path.Combine(Environment.CurrentDirectory, "SADST", _activeProfile.ProfileName));
                info.ShowDialog();
            }
        }
        ...
        private void btnMonitorNetLog_Click(object sender, EventArgs e)
        {
            ...
            if (!File.Exists(file))
            {
                MessageBox.Show("No net log file present", "SADST", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
